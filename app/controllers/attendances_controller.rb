class AttendancesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @attendance.save
        @notice_string = 'Congratulations! You registered for ' 
                         + Course.find(@attendance.course_id).title 
        if params[:send_to_skillchest]
          ...
          uri = URI('http://agile-everglades-3155.herokuapp.com/users/new_registration')
